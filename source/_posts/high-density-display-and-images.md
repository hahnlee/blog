...
레티나 디스플레이를 시작으로 다양한 고밀도 디스플레이 기기가 늘어났습니다. 이에 따라 웹 환경에서도 2x 이미지를 
...
{% asset_img img/img-load.png 사파리 이미지 로딩 %}
...
{% asset_img img/img-load-with-none.png display:none 이미지 %}
